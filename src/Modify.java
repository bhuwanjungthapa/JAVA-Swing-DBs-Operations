...
public class Modify extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource()==cbroll) {
            try {
                pstmt = dbc.con.prepareStatement("select * from studenttbl where rollno=?");
        ...
        {
            try {
                pstmt = dbc.con.prepareStatement("update studenttbl set fullname=?,level=?,faculty=?,semester=? where rollno=?");
